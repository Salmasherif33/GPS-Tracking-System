...
void UART2_Init()
{
	...
	//wait for the clock to be enabled to port D 
	...
	//allow changes to this bits
	
	GPIO_PORTD_CR_R = 0xFF;
	
	//select alternate function instead of GPIO
	
	GPIO_PORTD_AFSEL_R = GPIO_PD10_M;	//011000000
	
	// select uart2 alternate function
